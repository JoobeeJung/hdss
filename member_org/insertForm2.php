    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type="text" name="manager_name" value=<?= $_SESSION["name"]?>>
          <input type="text" name="manager_id" value=<?= $_SESSION["userid"]?>></td>
       ...
       <select name="birth2" required>
        ...
        <tr>
          <th>장애유형</th>
          <td>			   
               <input type="checkbox" name="mdt_retard" value="지체">지체
               <input type="checkbox" name="mdt_Brain_lesion" value="뇌병변">뇌병변
               <input type="checkbox" name="mdt_see" value="시각">시각
               <input type="checkbox" name="mdt_hear" value="청각">청각
               <input type="checkbox" name="mdt_language" value="언어">언어
               <input type="checkbox" name="mdt_face" value="안면">안면
               <input type="checkbox" name="mdt_respiratory" value="호흡기">호흡기
               <input type="checkbox" name="mdt_heart" value="심장">심장
               <input type="checkbox" name="mdt_kidney" value="신장">신장
               <input type="checkbox" name="mdt_liver" value="간">간
               <input type="checkbox" name="mdt_stoma_urostomy" value="장류/요루">장류/요루
               <input type="checkbox" name="mdt_epilepsy" value="간질">간질
               <input type="checkbox" name="mdt_mental" value="지적">지적
               <input type="checkbox" name="mdt_development" value="정신발달">정신발달</td></td>
...
&nbsp&nbsp&nbsp기타 내용: <input  type="text" name="major_disease_ect" ></td>
      ...
      <tbody>
        <tr>
          ...
          <td>
          <li>수축기<input type="text" name="mbe_blood_pressure1" required>mmHg&nbsp</li>
          <li>이완기<input type="text" name="mbe_blood_pressure2" required>mmHg&nbsp</li>
        ...
        <tr>
          ...
          <td>
        <input type="text" name="mbe_bmi" required>kg/m²
          </td>
        </tr>
               <tr>
          <th>당화혈색소<font color=red> * </font></th>
          <td>
          <input type="text" name="mbe_blood_glucose_before" value="<?=$mbe_blood_glucose_before?>" required>%&nbsp
          ...
          <td>
         <input type="text" name="mbe_chol" required>mg/dL
          </td>
        </tr>  
                <tr>
          <th>중성지방<font color=red> * </font></th>
          <td>
         <input type="text" name="mbe_tg" required>mg/dL
          </td>
        </tr> 
                <tr>
          <th>검진부서</th>
	...
	<input type="text" name="mbe_department" required>
                  ...
                  <table>
      <caption><h2>일상 생활 동작검사(K-MBI)</h2></caption>

      <tbody>
        <tr>
          <th >검사표</th>
          <td width="120">수행불가</td>
          <td width="120">상당한 도움필요</td>
          <td width="120">중간정도 도움필요</td>
          <td width="120">최소한의 도움필요</td>
          <td width="120">완전히 독립적</td>
        
        </tr>
        <tr>
          <th>몸 치장하기</th>
		  <td><input type="radio" name="mdl_hygiene" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_hygiene" id="F" value="1"></td>
		   <td><input type="radio" name="mdl_hygiene" id="F" value="3"></td>	
		    <td><input type="radio" name="mdl_hygiene" id="F" value="4"></td>	
		     <td><input type="radio" name="mdl_hygiene" id="F" value="5"></td>	 	
        </tr>
                <tr>
          <th>목욕하기</th>
		  <td><input type="radio" name="mdl_bath" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_bath" id="F" value="1"></td>
		   <td><input type="radio" name="mdl_bath" id="F" value="3"></td>	
		    <td><input type="radio" name="mdl_bath" id="F" value="4"></td>	
		     <td><input type="radio" name="mdl_bath" id="F" value="5"></td>	 	
        </tr>
                <tr>
          <th>식사하기</th>
		  <td><input type="radio" name="mdl_meal" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_meal" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_meal" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_meal" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_meal" id="F" value="10"></td>	 	
        </tr>
                <tr>
          <th>화장실 이동과 사용</th>
		  <td><input type="radio" name="mdl_toilet" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_toilet" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_toilet" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_toilet" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_toilet" id="F" value="10	"></td>	 	
        </tr>
                <tr>
          <th>계단이동</th>
		  <td><input type="radio" name="mdl_stair" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_stair" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_stair" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_stair" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_stair" id="F" value="10"></td>	 	
        </tr>
                <tr>
          <th>옷입기</th>
		  <td><input type="radio" name="mdl_clothe" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_clothe" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_clothe" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_clothe" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_clothe" id="F" value="10"></td>	 	
        </tr>
                <tr>
          <th>대변조절</th>
		  <td><input type="radio" name="mdl_poo_control" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_poo_control" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_poo_control" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_poo_control" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_poo_control" id="F" value="10"></td>	 	
        </tr>
                <tr>
          <th>소변조절</th>
		  <td><input type="radio" name="mdl_urine_control" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_urine_control" id="F" value="2"></td>
		   <td><input type="radio" name="mdl_urine_control" id="F" value="5"></td>	
		    <td><input type="radio" name="mdl_urine_control" id="F" value="8"></td>	
		     <td><input type="radio" name="mdl_urine_control" id="F" value="10"></td>	 	
        </tr>
                <tr>
          <th>걷기</th>
		  <td><input type="radio" name="mdl_walk" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_walk" id="F" value="3"></td>
		   <td><input type="radio" name="mdl_walk" id="F" value="8"></td>	
		    <td><input type="radio" name="mdl_walk" id="F" value="12"></td>	
		     <td><input type="radio" name="mdl_walk" id="F" value="12"></td>	 	
        </tr>
                <tr>
          <th>혹은 휠체어</th>
		  <td><input type="radio" name="mdl_wheelchair" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_wheelchair" id="F" value="1"></td>
		   <td><input type="radio" name="mdl_wheelchair" id="F" value="3"></td>	
		    <td><input type="radio" name="mdl_wheelchair" id="F" value="4"></td>	
		     <td><input type="radio" name="mdl_wheelchair" id="F" value="5"></td>	 	
        </tr>
                <tr>
          <th>의자/침대이동</th>
		  <td><input type="radio" name="mdl_movement" id="F" value="0"></td>
		  <td><input type="radio" name="mdl_movement" id="F" value="3"></td>
		   <td><input type="radio" name="mdl_movement" id="F" value="8"></td>	
		    <td><input type="radio" name="mdl_movement" id="F" value="12"></td>	
		     <td><input type="radio" name="mdl_movement" id="F" value="15"></td>	 	
        </tr>
      ...
      <?php   $manager_id=$_SESSION["userid"];
