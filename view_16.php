 ...
 <div id="wrap">
  ...
  <div id="content">
	...
	<div id="left_menu"><?php include "../lib/left_menu.php"; ?></div>
      ...
      <div id="col2">
          <div id="title"><img src="../img/exercise_recommend.png" ></div>      
        <div id="view_title">  
	  <div ></div> 
...
<p> <b><font color="blue"> <?	  print  $member_name  ?> 님의 맞춤형 운동추천 </font></b></p> 
<br> 환자번호 :  <input type ="text" name="num" style="width:50px;" value="<?=$member_num?> " ReadOnly="true">&nbsp'<b><?	  print  $member_name  ?></b>'님의 담당 보건 전문가는 <b><? print $member_manager_name ?></b>님 입니다.
    ...
    <table>
      ...
      <tr>
        ...
        <tr>
          ...
          <td><? print $member_mustle ?></td>
        </tr>
        <tr>
          <th style="float:center; " >지체유형</th>
          <td><? print $member_delay_type ?></td>
        </tr>
        <tr>
...
<fieldset style="background-color:#E6E6E6" >
    <legend ><span style="color:black" style="float:center; " >#선택사항</span></legend>
      ...
      <tr>
       ...
       <input type="checkbox" name="position3"  value="눕기" <?php if($position3 == "눕기") { echo "checked=true";}?> >&nbsp;눕기
         ...
         <td id="button" style="float:center; " ><input type="submit" id="select" value="선택적용"></td> <!--<a href="http://interlaw88.cafe24.com/test/updatePro_ex.php"> <onclick="check_input()"><b> 선택하여 조회</b> </a> </td>--!>
	</form>
                         </fieldset>  
                         <br>                                                      
       <fieldset>
    <legend >#추천된 <? 
   			  ...
   			  $sql2 = "select * from interlaw88.content where (type1='$member_major_disability' and ( type2= '$member_delay_type' or type2='$member_major_disability' or type2='$member_mustle' ))".$sql_add;
