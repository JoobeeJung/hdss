...
require_once("../lib/MYDB.php"); 
 ...
 <?php
  ...
  $sql="select * from interlaw88.member where member_manager_id like '%$now_manager%' order by member_num desc";
 }
*/
 if(isset($_SESSION["userid"])){
          if($now_manager=="interlaw88"){
 ...
 <?php  // 글 목록 출력
            ...
            <tr>
               ...
               <td align="center"><?=$row['member_id']?></td>
                ...
                <td align="center"><a href ="deletePro.php?num=<?=$row['member_num']?>"  onclick="return confirm('정말 삭제하시겠습니까?')" >삭제</a></td>
