...
&nbsp&nbsp&nbsp기타 내용: <input  type="text" name="major_disease_ect" ></td>
        ...
        <tr>
          <th> 운동유형 <font color=red> * </font></th>
            <td>
            <input type="radio" name="member_ex_type" value="근력"  >근력
     		<input type="radio" name="member_ex_type" value="유연성" >유연성
      	    <input type="radio" name="member_ex_type" value="유산소" >유산소
      	    <input type="radio" name="member_ex_type" value="균형"  >균형</td>
  		</tr>	
       	<tr>
          <th> 난이도 <font color=red> * </font></th>
       <td><input type="radio" name="member_ex_level"  value="상"  >상
       <input type="radio" name= "member_ex_level"  value="중"  >중
       <input type="radio" name= "member_ex_level"  value="하"  >하
       </td>
       </tr>     
      </tbody>
        </table>
