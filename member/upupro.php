<?php
 ...
 $birth = $birth1."-".$birth2."-".$birth3;
  $member_first_registration = $_REQUEST["member_first_registration"];
    $member_last_registration = $_REQUEST["member_last_registration"];
 ...
 $mr2_MAS4 = $_REQUEST["mr2_MAS4"];
   ...
   $mbe_blood_pressure = $_REQUEST["mbe_blood_pressure"];
 ...
 $mbe_department = $_REQUEST["mbe_department"];
   ...
   $mdl_total = $mdl_hygiene + $mdl_bath + $mdl_meal + $mdl_toilet 
   + $mdl_stair + $mdl_clothe + $mdl_poo_control + $mdl_urine_control
   + $mdl_walk + $mdl_wheelchair + $mdl_movement;
 ...
 try{
    ...
    $sql = "update interlaw88.member set member_manager_id=?, 
    ...
    member_ex_level=?, member_ex_type=?  where member_num = '$member_num'";
    ...
    $stmh->bindValue(12, $member_first_registration, PDO::PARAM_STR);
    $stmh->bindValue(13, $member_last_registration, PDO::PARAM_STR);
    $stmh->bindValue(14, $member_ex_level, PDO::PARAM_STR);
    $stmh->bindValue(15, $member_ex_type, PDO::PARAM_STR);
    ...
    $pdo->beginTransaction();   
    $select_sql = "select member_num from interlaw88.member where member_num = '$member_num'";  
    ...
    $pdo->beginTransaction();   
    $sql = "update interlaw88.member_disability_type set member_num=?, 
    ...
    mdt_intellectual=?,mdt_mental=?,mdt_development=? where  member_num = '$member_num'";
    $stmh = $pdo->prepare($sql); 
    ...
    $pdo->beginTransaction();   
    $sql = "update interlaw88.member_basic_examination set member_num=?, mbe_blood_pressure1=?, mbe_blood_pressure2=?,
    mbe_pulse=?, mbe_breath=?, mbe_temperature=?, mbe_weight=?, mbe_height=?, mbe_bmi=?, mbe_blood_glucose_before=?, 
    mbe_blood_glucose_after=?, mbe_chol=?, mbe_tg=?, mbe_department=? where member_num = '$member_num' ";

    $stmh = $pdo->prepare($sql); 
    $stmh->bindValue(1, $member_num, PDO::PARAM_STR);
    $stmh->bindValue(2, $mbe_blood_pressure1, PDO::PARAM_STR);
    $stmh->bindValue(3, $mbe_blood_pressure2, PDO::PARAM_STR);
    ...
    $pdo->beginTransaction();   
    $sql = "update interlaw88.member_daily_living set member_num=?, mdl_total=?, 
    mdl_hygiene=?, mdl_bath=?, mdl_meal=?, mdl_toilet=?, mdl_stair=?, mdl_clothe=?, mdl_poo_control=?, 
    mdl_urine_control=?, mdl_walk=?, mdl_wheelchair=?, mdl_movement=? where member_num = '$member_num' ";
    $stmh = $pdo->prepare($sql); 
    $stmh->bindValue(1, $member_num, PDO::PARAM_STR);
    ...
    $pdo->beginTransaction();   
    $sql = "update interlaw88.member_rehabilitation1 set member_num=?, mr1_onset=?, 
    mr1_pain_point=?, mr1_pain_level=?, mr1_medicine=?, mr1_helpingtool=?, mr1_pedestal=?, 
    mr1_extra_instrument=?, mr1_caregiver=?, mr1_family=? where member_num = '$member_num' ";
    $stmh = $pdo->prepare($sql); 
    $stmh->bindValue(1, $member_num, PDO::PARAM_STR);
    ...
    $pdo->commit(); 
        ...
        $pdo->beginTransaction();   
    $sql = "update interlaw88.member_rehabilitation2 set member_num=?, mr2_consciousness=?
    ...
    mr2_FRAX_total=?, mr2_FRAX_tscore=?, mr2_SFT_1=?, mr2_SFT_2=?, mr2_MAS4=? where member_num = '$member_num' ";
